...
example_one_name_space = Namespace('exampleone', description='Example APIs')


@example_one_name_space.route("/")
class ExampleEndpoint(Resource):
    ...
    @example_one_name_space.doc(responses={200: 'Ok',
                                           500: 'Internal Server Error'})
    def get(self):
        return make_response(self.__success([]), 200)

    model = example_one_name_space.model("arguments", {
    ...
    parser = example_one_name_space.parser()
